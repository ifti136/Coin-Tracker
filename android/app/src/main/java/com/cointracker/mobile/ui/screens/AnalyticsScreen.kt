        ...
        LazyColumn(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.spacedBy(16.dp)) {
            ...
            item {
                ...
                GlassCard(modifier = Modifier.height(200.dp)) {
                    ...
                    if (txns.isNotEmpty()) {
                        ...
                        Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) { Text("No Data", color = textColor) }
                    }
                }
            }
            ...
            item {
                ...
                if (earnings.isNotEmpty()) {
                    PieChartWithLegend(data = earnings, textColor = textColor)
            ...
            item {
                ...
                if (spending.isNotEmpty()) {
                    PieChartWithLegend(data = spending, textColor = textColor)
